...
export default function XssMedium() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch('/dvwa/xss/medium', {
                method: 'POST',
                headers: {
            ...
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
                <div className="mx-auto max-w-5xl space-y-6">
                    ...
                    <Alert>
                        ...
                        <AlertDescription>
                            <strong>Tujuan:</strong> Bypass basic filtering
                            untuk eksploitasi XSS.
                            <br />
                            <strong>Hint:</strong> Server menghilangkan{' '}
                            <code>{'<script>'}</code>. Coba:{' '}
                    ...
                    <Card className="border-orange-200 bg-orange-50">
                        ...
                        <CardContent className="space-y-2 text-orange-800">
                            <p>
                                ...
                                basic filtering dengan menghilangkan{' '}
                                <code>{'<script>'}</code>, tapi masih bisa
                                di-bypass.
                            </p>
                            <p>
